...
const options = [
  'הכל',
  'לביצוע',
  'טרם נשלחה הזמנה לדיגום',
  'בוצע דיגום חלקי',
  'בוצע דיגום מלא',
  'נסגר על ידי המזמין',
  'לא נשלחה הודעה לצרכן לתכנית ',
  'לא נשלח מכתב חיוב על דיגום חריג/אסור',
  'מי רקע',
  'נפסל',
  'בוטל',
];
...
function ConfirmationDialogRaw(props) {
  ...
  return (
    <Dialog dir='rtl'
      ...
      {...other}
    >
      <DialogTitle sx={{ textAlign: 'center', fontSize: '2.5rem' }}>סטטוס</DialogTitle>
    ...
    <Box sx={BoxStyle} >
      <List component="div" role="group" >
        <ListItemButton
          ...
          sx={{
            background: '#f9f9f9', boxShadow: '0 2px 5px rgba(0, 0, 0, 0.1)',
            maxWidth: '140%',
          }}
        >
          <ListItemText primary="סטטוס" secondary={value} sx={{ textAlign: 'center', fontSize: '2.5rem' }} />
        </ListItemButton >
