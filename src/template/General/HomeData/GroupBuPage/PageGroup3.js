...
function ConfirmationDialogRaw(props) {
  ...
  return (
    <Dialog dir='rtl'
      ...
      {...other}
    >
      <DialogTitle sx={{ textAlign: 'center', fontSize: '2.5rem' }}>הזמנה לביצוע דיגום מי רקע</DialogTitle>
...
export default function PageGroup3() {
  ...
  return (
    <Box sx={BoxStyle} >
      <List component="div" role="group" >
        ...
        >
          <ListItemText primary='הזמנה לדיגום מי רקע' sx={{ textAlign: 'center', fontSize: '2.5rem', color: '#1976d2' }} />
        </ListItemButton >
