...
function ConfirmationDialogRaw(props) {
  ...
  return (
    <Dialog dir='rtl'
      ...
      {...other}
    >
      <DialogTitle sx={{ textAlign: 'center', fontSize: '2.5rem' }}>קליטת תוצאות דיגום   מי רקע</DialogTitle>
...
export default function PageGroup5() {
  ...
  return (
    <Box sx={BoxStyle} >
      <List component="div" role="group" >
        ...
        >
          <ListItemText primary='עדכון תוצאות דיגום שפכי תעשייה' sx={{ textAlign: 'center', fontSize: '2.5rem', color: '#1976d2' }} />
        </ListItemButton >
