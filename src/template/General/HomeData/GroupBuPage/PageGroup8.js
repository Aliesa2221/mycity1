...
function ConfirmationDialogRaw(props) {
  ...
  return (
    <Dialog dir='rtl'
      ...
      {...other}
    >
      <DialogTitle sx={{ textAlign: 'center', fontSize: '2.5rem' }}>ביטול התראות דיגום</DialogTitle>
...
export default function PageGroup8() {
  ...
  return (
    <Box sx={BoxStyle} >
      <List component="div" role="group" >
        ...
        >
          <ListItemText primary='ביטול התראות דיגום' sx={{ textAlign: 'center', fontSize: '2.5rem', color: '#1976d2' }} />
        </ListItemButton >
